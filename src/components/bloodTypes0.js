  ...
  useEffect(() => {
    UserService.getUsers()
      .then((response) => {
        ...
        const usersAPlus = allUsers.filter((user) => user.bloodType === "O" && user.rhFactor === "+");
        const usersAMinus = allUsers.filter((user) => user.bloodType === "O" && user.rhFactor === "-");
  ...
  return (
    <div>
      <div className="card card-container">
        <h2 className="list-heading">Svi darivatelji (0+)</h2>
